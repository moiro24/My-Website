          ...
          <div className='rounded-3xl bg-white/[0.05]'>
            <div className='flex'>
              <div className='hidden w-full lg:block lg:w-1/2'>
                <div className='relative py-20 pr-22 pl-17.5'>
                  <div className='absolute top-0 right-0 h-full w-[1px] bg-linear-to-b from-white/0 via-white/20 to-white/0'></div>

                  <h2 className='text-heading-4 mb-10 max-w-[292px] font-bold text-white'>
              ...
              <div className='w-full lg:w-1/2'>
                <div className='py-8 pr-8 pl-8 sm:py-20 sm:pr-20 sm:pl-21'>
                  <div>
                    <SocialSignup />

                    <span className='relative my-7.5 block text-center text-sm font-medium'>
                      <span className='absolute top-1/2 left-0 block h-[1px] w-22.5 bg-white/[0.12]'></span>
                      <span className='absolute top-1/2 right-0 block h-[1px] w-22.5 bg-white/[0.12]'></span>
                      ...
                      <form onSubmit={registerUser}>
                        <div className='relative mb-4'>
                          ...
                          <input
                            ...
                            className='focus:border-purple w-full rounded-lg border border-white/[0.12] bg-transparent py-3.5 pr-4 pl-14.5 font-medium text-white outline-hidden focus-visible:shadow-none'
                          />
                        </div>
